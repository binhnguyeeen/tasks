...
- **`mac/`**: a SwiftUI menu bar app for macOS 26 or later on Apple silicon. Shows a due count, quick add with date parsing, Overdue and Today, plus a full window with lists, subtasks and search.
