/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 724dae9ef53c3f13217cffc0ec218e14)
// Runtime types generated with workerd@1.20260918.1 2026-09-01 nodejs_compat
interface __BaseEnv_Env {
	OAUTH_KV: KVNamespace;
	TIMEZONE: "Asia/Ho_Chi_Minh";
	HOMEPAGE_URL: "https://binhnguyeeen.github.io/tasks/";
	GOOGLE_CLIENT_ID: string;
	GOOGLE_CLIENT_SECRET: string;
	COOKIE_ENCRYPTION_KEY: string;
	ALLOWED_EMAILS: string;
	MCP_OBJECT: DurableObjectNamespace<import("./src/index").TasksMCP>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TasksMCP";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TIMEZONE" | "HOMEPAGE_URL" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "COOKIE_ENCRYPTION_KEY" | "ALLOWED_EMAILS">> {}
}
